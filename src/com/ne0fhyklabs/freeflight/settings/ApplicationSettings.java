package com.ne0fhyklabs.freeflight.settings;
...
public class ApplicationSettings
{
    ...
    public static final boolean DEFAULT_OCULUS_MODE_ENABLED = false;
    ...
    /**
     * Configures the drone video display for viewing by oculus rift devices
     *
     * @param enabled
     *            - true to enable, false to disable
     */
    public void setOculusModeEnabled(boolean enabled) {
        saveProperty(EAppSettingProperty.OCULUS_MODE_PROP, enabled);
    }

    public boolean isOculusModeEnabled() {
        return getProperty(EAppSettingProperty.OCULUS_MODE_PROP, DEFAULT_OCULUS_MODE_ENABLED);
    }
