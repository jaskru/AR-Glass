...
import com.ne0fhyklabs.freeflight.ui.VideoController;
import com.ne0fhyklabs.freeflight.ui.adapters.GalleryAdapter;
import com.ne0fhyklabs.freeflight.ui.adapters.GalleryAdapterDelegate;
import com.ne0fhyklabs.freeflight.utils.DeviceCapabilitiesUtils;
...
public class GalleryActivity extends FragmentActivity implements
    ...
    public void onPlayButtonClicked(ViewGroup parent) {
        if (DeviceCapabilitiesUtils.getMaxSupportedVideoRes() == EVideoRecorderCapability
                .NOT_SUPPORTED) {
    ...
    private void playVideoInExternalPlayer() {
        ...
        Log.d(TAG,
                "Error occured while trying to play video via embedded player. Trying to play " +
                        "video in external player");
    ...
    private void setMediaViewVisible(boolean visible) {
        ...
        if (visible) {
            ...
            if (videoView != null) {
                ...
                Log.w(TAG,
                        "Unable to make video view invisible. It has not been found in view " +
                                "hierarchy.");
            }
        }
    }
